  ...
  const emailOptions = {
    ...
    html: `
        <div style="font-family: Arial, sans-serif;">
          <h1 style="text-align: center; font-size: 1.5rem; color: #7F1022;">Welcome to Truckers Talents INC.</h1>
          <p style="font-size: 1rem;">
            Thank you for signing up to our website. To complete your registration, please verify your email address with your verification code:
          </p>
          <p style="text-align: center; color: #7F1022; font-size: 1.5rem; margin: 0.5rem;">
            <strong>${code}</strong>
          </p>
          <p style="font-size: 1rem;">
            Go with your code to the verification page:
          </p>
          ...
          <p style="font-size: 1rem;">
            ...
            <a style="font-size: 1rem; color: #7F1022;" href="${process.env.FRONTEND_URL}/verify">
              ${process.env.FRONTEND_URL}/verify
            </a>
          </p>
          <p style="font-size: 1rem; font-style: italic;">
            Your verification code will expire in 15 minutes. Please, verify as soon as possible.
          </p>
          <p style="font-size: 1rem;">
